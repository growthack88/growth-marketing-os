<!--
COMMUNITY RESOURCE — included under its original MIT license.
Source: https://github.com/jmedia65/awesome-ai-marketing (MIT).
License text: LICENSE-awesome-ai-marketing.txt
Snapshot vendored into Growth Marketing OS on 2026-07-03 — check the source
repo for the latest version. This file is NOT original work by the repo author.
-->
